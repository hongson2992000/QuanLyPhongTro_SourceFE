<%-- 
    Document   : home
    Created on : Jun 6, 2022, 9:08:31 PM
    Author     : Admin
--%>
        ...
        <div class="screen-main">
                        ...
                        <div class="navbar-collapse">
                            ...
                            <ul class="navbar-nav navbar-nav-right">
                                <li class="nav-item nav-item-link">
                                    <a target="_blank" class="nav-link" href="https://chat.zalo.me/">Đăng Nhập</a>
                                </li>
                                <li class="nav-item nav-item-btn">
                                    <a target="_blank" class="nav-link-register btn btn-primary" href="https://chat.zalo.me/">Đăng Ký</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
                    ...
                    <div class="row">
                        <div class="col-5 combobox-district">
                            <select class="combobox-district-detail">
                                <option value="Select">Chon Tinh/Thanh Pho</option>
                        ...
                        <div class="col-5 combobox-detail">
                            <select class="combobox-address">
                                <option value="Select">Chon Quan/Huyen</option>
                                <option value="php">php</option>
                                <option value="html">html</option>
                                <option value="javascript">Javascript</option>
                                <option value="CPP">CPP</option>
            ...
            <!--            <div class="block-footer">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <span style="font-size: 50px;text-align: center">Liên Kết Nhận Thông Tin</span><br/>
